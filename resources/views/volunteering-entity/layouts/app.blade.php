...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    <!-- Navbar -->
    <nav style="box-shadow: 0px -2px 9px 2px #b7b2b27a !important;" class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
         data-scroll="true">
            ...
            <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                ...
                <ul class="navbar-nav  justify-content-end">
                    <li class="nav-item d-flex align-items-center">
                        ...
                        <form style="display: none" method="post" action="{{route('volunteering-entity.signOut')}}" id="logoutForm">@csrf</form>
                        </a>
                    </li>
