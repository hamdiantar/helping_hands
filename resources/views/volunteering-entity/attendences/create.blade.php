...
@section('breadcrumb')
    <li><a href="#">{{$opportunity->OPP_NAME}} > Attendances ></a> > Add New</li>
@endsection
@section('content')
                ...
                <div class="card my-4">
                    ...
                    <div class="card-header p-0 position-relative mt-n4 mx-3">
                        <div class="bg-gradient-warning shadow-warning border-radius-lg pt-3 pb-3">
                            <h6 class="text-white text-capitalize ps-3">{{$opportunity->OPP_NAME}} > Add New Attendance</h6>
                    ...
                    <div class="card-body ml-3 mr-3">
                        <form id="form" method="post" action="{{route('volunteering-entity.opportunities.attendances.store',  $opportunity->OPP_ID)}}">
                            @csrf
