...
@section('breadcrumb')
    <li><a href="#">subscription Management </a> > Add New</li>
@endsection
@section('content')
                ...
                <div class="card my-4">
                    ...
                    <div class="card-header p-0 position-relative mt-n4 mx-3">
                        <div class="bg-gradient-warning shadow-warning border-radius-lg pt-3 pb-3">
                            <h6 class="text-white text-capitalize ps-3">subscription Management > Add New</h6>
                            <a href="{{route('admin.subscription.index')}}"
                               class="btn btn-dark btn-sm btn-add"><i class="fa fa-times fs-15"></i></a>
                        </div>
                    </div>
                    <div class="card-body ml-3 mr-3">
                        <form method="post" action="{{route('admin.subscription.store')}}" id="form">
                            @csrf
