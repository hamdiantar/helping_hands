                ...
                <div class="card my-4">
                    ...
                    <div class="card-header p-0 position-relative mt-n4 mx-3">
                        <div class="bg-gradient-warning shadow-warning border-radius-lg pt-3 pb-3">
                            ...
                            <a href="{{route('admin.opportunities.create')}}" class="btn bg-gradient-dark btn-sm btn-add"><i
                            ...
                            <table class="table  table-bordered mb-0 text-center" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        ...
                                        <a href="{{route('admin.opportunities.edit', 1)}}" class="text-secondary font-weight-bold text-xs  ml-2"
                                           data-toggle="tooltip" data-original-title="Edit user">
