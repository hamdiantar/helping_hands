...
function darkMode(el) {
  ...
  const text_span = document.querySelectorAll('span.text-dark, .breadcrumb.blade.php .text-dark');
  const text_span_white = document.querySelectorAll('span.text-white, .breadcrumb.blade.php .text-white');
