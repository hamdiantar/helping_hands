  <div class="row">
    ...
    <div class="input-group col-md-12 input-group-outline mb-3 is-filled">
        ...
        <textarea rows="4" name="VOL_CH_NAME"  class="form-control" onfocus="focused(this)" onfocusout="defocused(this)">{{isset($item) ? $item->VOL_CH_NAME : old('VOL_CH_NAME')}}</textarea>
    </div>
